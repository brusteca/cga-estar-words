...
var config = {
	...
	scripts : {
		...
		'shootscript': [{"time":6.18,"key":37,"duration":0.49},{"time":6.67,"key":87,"duration":2.01},{"time":7.48,"key":40,"duration":0.3},{"time":8.68,"key":39,"duration":0.97},{"time":9.23,"key":38,"duration":0.45},{"time":10.08,"key":40,"duration":0.22},{"time":10.5,"key":32,"duration":0.13},{"time":11.3,"key":39,"duration":0.35},{"time":11.82,"key":32,"duration":0.05},{"time":11.87,"key":83,"duration":1.33},{"time":12.75,"key":40,"duration":0.15},{"time":13.32,"key":32,"duration":0.13},{"time":15.73,"key":17,"duration":0},{"time":16.05,"key":79,"duration":0}],
	},
	...
	models : [
		...
		{ type : "tie", transform : { translate : {x : 40, y : -240, z : 20}, rotation : { x : 0, y : 90, z : 0}}, script : "tieGroup1" },
		{ type : "tie", transform : { translate : {x : 40, y : -240, z : 20}, rotation : { x : 0, y : 90, z : 0}}, script : "shootscript" },
