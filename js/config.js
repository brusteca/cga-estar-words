...
var config = {
	...
	models : [
		...
		// { type : "tie_fighter", transform : { translate :  {x : 40, y : -140, z : 20}, rotation : { x : 0, y : 90, z : 0}, scale: {x: 8, y: 8, z: 8}}, options: {script : 'emptyScript', laser: 'purple', topSpeed: 6, acceleration: 1} },
